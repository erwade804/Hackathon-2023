void initbuildings () { // all bulidings to memory
  ...
  buildings.add(new building("shack", 1, 1, "shack.png", 2, 1, null, color(0, 0, 1), 120, 0, 10, 0, 0, 0));
  ...
  // food
  buildings.add(new building("farm", 10, 10, "farmHouse.png", 2, 1, null, color(1, 0, 1), 150, 0, 20, 0, 0, 0));
  buildings.get(4).art.resize(50, 50);
  buildings.add(new building("fishing wharf", 10, 10, "fishingWharf.png", 5, 3, null, color(1, 1, 1), 200, 15, 15, 0, 0, 0));
  buildings.get(5).art.resize(50, 50);
  
  
  // resources, not linked
  buildings.add(new building("stone quarry", 10, 10, "Stonequarry.png", 5, 2, null, color(2, 0, 1), 200, 0, 10, 15, 0, 0));
  buildings.get(6).art.resize(50, 50);
  buildings.add(new building("woodcutters hut", 10, 10, "WoodHut.png", 5, 2, null, color(2, 1, 1), 180, 10, 10, 0, 0, 0));
  ...
  buildings.add(new building("iron mine", 10, 10, "Ironmine.png", 5, 4, null, color(2, 3, 1), 300, 15, 10, 0, 0, 0));
  buildings.get(8).art.resize(50, 50);
  //buildings.add(new building("smeltry", 10, 10, "", 10, 6, null, color(2, 4, 2), 800, 350, 250, 400, 0, 100));
  //buildings.get(7).art.resize(100, 100);
  buildings.add(new building("gold mine", 10, 10, "Goldmine.png", 5, 4, null, color(2, 5, 1), 150, 15, 0, 15, 0, 0));
  ...
  //Wonder
  buildings.add(new building("presidential Statue", 600, 600, "presidentkiwi.png", 40, 0, null, color(4, 2, 1), 10000, 3000, 3000, 2000, 500, 750));
