void initbuildings () { // all bulidings to memory
  ...
  buildings.add(new building("goldMine", 10, 10, "", 1, 0, null, color(0, 0, 5)));
  buildings.add(new building("woodcuttersHut", 10, 10, "", 1, 0, null, color(0, 0, 6)));
  buildings.add(new building("loggingIndustry", 10, 10, "", 1, 0, null, color(0, 0, 7)));
  buildings.add(new building("ironMine", 10, 10, "", 1, 0, null, color(0, 0, 8)));
  buildings.add(new building("smeltry", 10, 10, "", 1, 0, null, color(0, 0, 9)));
  buildings.add(new building("bank", 10, 10, "", 1, 0, null, color(0, 0, 10)));
